...
export default function PlaceItem({ placeData, isList = false }: PlaceItemIntertace) {
    ...
    return (
      ...
      >
        <img
          ...
          src={"https://fanilotour.onrender.com/" + placeData.photos[0]}
  ...
  return (
    <Link
      to={"/place/" + placeData._id}
      className="flex flex-col items-start mb-2 max-w-xs shadow-md shadow-gray-400"
    >
      <img
      ...
      <p className="text-xs mt-4 text-start p-2">
